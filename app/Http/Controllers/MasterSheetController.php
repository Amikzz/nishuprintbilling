...
class MasterSheetController extends Controller
{
    ...
    public function createMasterSheet(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'print_date' => 'nullable|date', // Ensure print date is after or equal to required date
            'invoice_date' => 'nullable|date', // Ensure invoice date is after or equal to print date
        ...
        try {
            MasterSheet::create([
                ...
                'print_date' => $validated['print_date'],
            ...
            return redirect()->route('mastersheet')->with('error', 'Failed to create Master Sheet. Please try again later.');
        }
    }
}
